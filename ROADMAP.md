...
in a migrated deployment) with append-only audit; a 79-route application with
...
| [ ] P2.9 | 10M-profile load certification | L | med | P2.1-P2.7 | The published harness drives the planning targets above against the HA topology during a rolling deploy and one induced failover; the numbers are committed. REALIZED BY P2.14, whose benchmark run IS this certification |
