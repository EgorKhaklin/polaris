...
| [ ] P0.6 | Signed artifacts and provenance | M | med | P0.5 | Images and release artifacts cosign-signed; SLSA provenance attested in CI; a verification command in the docs |
| [ ] P0.7 | ZK production profile | M | med | - | Tree depth parameterized with a documented production profile; prove/verify benchmarked at production depth; the zk-soundness ledger updated. Amended at v9.161: also evaluate the plonky2 0.2 to 1.x major here (proof-format compatibility + two-witness revalidation), declined as a blind Dependabot merge in P0.3 |
