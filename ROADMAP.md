...
| [ ] P0.7 | ZK production profile | M | med | - | Tree depth parameterized with a documented production profile; prove/verify benchmarked at production depth; the zk-soundness ledger updated |
