...
7. ✅ Test coverage: 1067 Python (12 test classes incl. property + redaction-property) + 171 SQL self-tests (achieved v6/v7; growing each release — last counted via ai-test-counts.sh)
