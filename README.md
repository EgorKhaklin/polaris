...
**Now shipping [v9.52](https://github.com/EgorKhaklin/polaris-id/releases/latest)** &nbsp;·&nbsp; 972 structural invariants &nbsp;·&nbsp; 650 cross-references resolved &nbsp;·&nbsp; one double-click to launch
...
```
                 ...
                 │  1,077 Python tests · 972 structural invariants  │
